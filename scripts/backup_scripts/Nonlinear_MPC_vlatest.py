...
class MPCKinematicNode:
    ...
    def find_nearest_index(self,car_pos):
        ...
        if win_upper_value>win_lower_value:
            ...
            search_waypoints = np.concatenate((self.path_points[win_lower_value:,:],self.path_points[0:win_upper_value,:]),axis=0)
        ...
        return min_dist_idx,win_lower_value,win_upper_value
